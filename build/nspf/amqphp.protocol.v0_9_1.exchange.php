...
class DeclareInternalField extends \amqphp\protocol\v0_9_1\BitDomain implements \amqphp\protocol\abstrakt\XmlSpecField
{
    function getSpecFieldName() { return 'internal'; }
    function getSpecFieldDomain() { return 'bit'; }
...
class DeclareMethod extends \amqphp\protocol\abstrakt\XmlSpecMethod
{
    ...
    protected $fields = array('reserved-1', 'exchange', 'type', 'passive', 'durable', 'auto-delete', 'internal', 'no-wait', 'arguments');
    protected $methFact = '\\amqphp\\protocol\\v0_9_1\\exchange\\MethodFactory';
    protected $fieldFact = '\\amqphp\\protocol\\v0_9_1\\exchange\\FieldFactory';
    protected $classFact = '\\amqphp\\protocol\\v0_9_1\\ClassFactory';
    protected $content = false;
...
class ExchangeClass extends \amqphp\protocol\abstrakt\XmlSpecClass
{
    ...
    protected $index = 40;
    protected $fields = array();
    protected $methods = array(10 => 'declare',11 => 'declare-ok',20 => 'delete',21 => 'delete-ok',30 => 'bind',31 => 'bind-ok',40 => 'unbind',51 => 'unbind-ok');
    protected $methFact = '\\amqphp\\protocol\\v0_9_1\\exchange\\MethodFactory';
    protected $fieldFact = '\\amqphp\\protocol\\v0_9_1\\exchange\\FieldFactory';
}
